            ...
            <form class="mt-8 space-y-6" action="" method="POST">
                <div class="rounded-md shadow-sm -space-y-px">
                    ...
                    <div>
                        ...
                        <input id="username" name="username" type="text" required 
                            class="appearance-none relative block w-full px-3 py-4 border border-gray-700 bg-gray-900/50 placeholder-gray-500 text-white focus:outline-none focus:ring-violet-500 focus:border-violet-500 focus:z-10"
                ...
                <div class="text-center">
                    <p class="text-sm text-gray-400">
                        ...
                        <a href="/signin.php" class="font-medium text-violet-400 hover:text-violet-500">Sign in</a>
                    </p>
                </div>
            </form>
        </div>
